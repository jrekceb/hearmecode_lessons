...
if bread > 1 and peanut_butter >= 1 and jelly >= 1:
	...
	print "I can make this {0} many sandwiches today.".format(sandwiches)
elif open_face == 1 and peanut_butter >=1 and jelly >= 1:
	print "I can make an open face sandwich"
elif bread > 1 and peanut_butter > 1 and jelly == 0:
	bpsandwiches = min(bread/2,peanut_butter)
	print "I can make this {0} many peanut butter sandwiches".format(bpsandwiches)
elif bread > 1 and jelly > 1 and peanut_butter == 0:
	bjsandwiches = min(bread/2,jelly)
	print "I can make this {0} many jelly sandwiches".format(bjsandwiches)
else:
	if bread < 2:
...
#		Continue from the fourth goal, but this time if you don't have enough ingredients, print a message that tells you which ones you're missingbread > 1 and peanut_butter > 1 and jelly > 1